...
func TestCommand_Validation(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"-src-type not valid": {
			[]string{"-src-type", "invalid", "foo", "bar"},
...
// Test that creating an intention with -src-type != consul fails
// since not Consul Enterprise.
func TestCommand_SrcTypeNonConsulFails(t *testing.T) {
	t.Parallel()
